package com.example.alioss.data.di
...
object DataModule {
    ...
    fun provideDatabase(
        ...
        Log.i("DataModule", "Creating database with name: alioss.db")
        Log.i("DataModule", "Database schema version: 7")
        Log.i("DataModule", "Number of migrations: ${ALL_MIGRATIONS.size}")

        val builder = Room.databaseBuilder(context, AliossDatabase::class.java, "alioss.db")
        ...
        val shouldEnableDestructiveFallback = try {
            ...
            val appBuildConfig = Class.forName("com.example.alioss.BuildConfig")
    ...
    fun providePreferencesDataStore(
        ...
        PreferenceDataStoreFactory.create(
            ...
            produceFile = { context.preferencesDataStoreFile("alioss_settings") },
        )
    ...
    fun provideAchievementsDataStore(
        ...
        PreferenceDataStoreFactory.create(
            corruptionHandler = ReplaceFileCorruptionHandler { emptyPreferences() },
            produceFile = { context.preferencesDataStoreFile("alioss_achievements") },
        )
